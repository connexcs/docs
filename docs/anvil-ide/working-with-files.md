...
Click any file in the Explorer to open it in the editor. Files are saved directly to ConnexCS — there is no local copy. <br><img src= "/apps/img/aide21.png" width= "400" style="border: 2px solid #4472C4; border-radius: 8px;"></br>
