...
* **Weight**: You can allocate the server that permits the highest traffic or call volume. This means the server with the highest weight will handle more traffic or calls compared to other servers.
