...
1. Go to Developer :material-menu-right: Scriptforge IDE :material-menu-right: Pages and click <img src="/pages/add.png" alt="add" width="150"/> to create anew form.

<img src="/pages/pages-page.png" alt="pages-page" width="300"/>

2. Complete the form's **Name** and **Title** fields, then click **Save**.

<img src="/pages/name-and-title.png" alt="name-and-title" width="300"/>
...
<img src="/pages/fields.png" alt="fields" width="300"/>

### Basic Fields

| **Field Name**      | **Description**                                                                                                                                                                                                                                                           | **Icon** | **Input** | **Output** |
|-----------------    |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------|-------|--------|
| **Input**           | User can enter single line text                                                                                                                                                                                                                                       |<img src="/pages/input-icon.png" alt="input-icon" width="300"/>|<img src="/pages/input-input.png" alt="input-input" width="300"/>| <img src="/pages/input-output.png" alt="input-output" width="300"/>         |
| **Input**           | User can enter single line text                                                                                                                                                                                                                                       |    |        |        |
...
| **Cascader**        | It multi-level dropdown option (Select option)                                                                                                                                                                                                                        |      |       |        |
