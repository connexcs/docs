...
|<img src="/pages/select.png" alt="select" width="85"/>      | **Select**          | Dropdown with various options; you can either select one or many options                                                                                                                                                                                              |
|<img src="/pages/time.png" alt="time" width="65"/>      | **Time**            | Allows you to pick a time (hh: mm :ss)                                                                                                                                                                                                                                  |
|<img src="/pages/date.png" alt="date" width="65"/>      | **Date**            | Allows you to pick a date (yyyy-MM-dd)                                                                                                                                                                                                                                |
