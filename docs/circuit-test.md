...
|**Answered**|Call has been connected and answered|
|**Destroyed**|Call has been killed|
|**Direction**|Either **Termination** or **Origination**|
...
|**Released By**|BYE message sent by- Upstream or Downstream |
