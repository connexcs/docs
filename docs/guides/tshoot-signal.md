...
Signalling is the process telephony systems use to setup, maintain, and end calls. While there are many different signalling protocols used for various types of deployments, ConnexCS uses SIP signaling. 
