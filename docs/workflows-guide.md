...
1. **Create or select an app in IDE** ([IDE](ide.md))
...
2. **Create the AI Agent** ([AI Agent](class5/ai-agent.md))
...
**Reference:** [AI Agent](class5/ai-agent.md)
...
1. **Install the Contact Center App** ([Contact Center](apps/contact.md))
...
**Reference:** [Contact Center Setup & Usage Guide](apps/contact.md)
...
**Developer:**
   ...
   - Script creation
   - Database queries
   - AI Agent creation and MCP workflows
...
**End User (Customer Portal):**
   ...
   - Manage DIDs
   - Configure IVR
   - Access Contact Center or customer-facing Apps
