...
<img src= "docs/apps/img/app1.png">

1. The created application will be visible on the App interface, then you have the option to **Publish** it using the `Settings` button and provide a **Version** to it as well. The **Domain** field will display where the App gets published.
...
<img src= "/developers/img/app2.png" width= "1000">
