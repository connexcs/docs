...
**Related Topics**: [ConnexCS Applications Overview](https://docs.connexcs.com/architecture/apps/), [ScriptForge Scripting Reference](https://docs.connexcs.com/apps/architecture/scriptforge/), [Database Integration](https://docs.connexcs.com/apps/architecture/database/)
