...
<br>**Prerequisites**: Active ConnexCS (ConnexCS) account with access to the Customer module and permission to manage contracts.</br>
<br>**Related Topics**: [Setup → Config → Contracts](https://docs.connexcs.com/setup/config/contracts/), [Documents (KYC & Upload)](https://docs.connexcs.com/customer/documents/)</br>
