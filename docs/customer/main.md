...
!!! nEach specific customer's portal can be accessed by clicking on the dropdown against the customer's name.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTYzNjc4MDE4LC0xMjk4NTQ0OTM1LC0xND
k0ODc3NzMzXX0=
-->