...
<br>**Related Topics**: [Customer – Latest Calls](https://docs.connexcs.com/customer/latest-calls/), [Logging & Call Detail Records (CDR)](https://docs.connexcs.com/logging/)</br>
