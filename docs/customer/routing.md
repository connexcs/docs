...
!!! tip "Using **The recommended RTP Media Proxy servers are the Closest (To ConnexCS) server or the Closest (Elastic) server."
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ2MDA1Nzg5NiwtMzAyMDcwNjUwLDQxNj
EwNzkyMiwtMjA0NzcyODE5Ml19
-->