...
|**EEA**| If a call originates from a CLI starting with ‘33’ (France) and the destination number starts with ‘43’ (Austria)| When a call originates from any country worldwide and terminates in any country, not limited to EEA|
